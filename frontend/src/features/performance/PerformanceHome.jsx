    ...
    return (
        <>
            ...
            <div style={{ display: 'flex', gap: 20, marginBottom: 24, borderBottom: '1px solid var(--border)' }}>
                <div 
                    style={{ padding: '12px 16px', cursor: 'pointer', borderBottom: activeTab === 'reviews' ? '2px solid var(--primary)' : 'none', color: activeTab === 'reviews' ? 'var(--primary)' : 'var(--text-muted)', fontWeight: activeTab === 'reviews' ? 600 : 400 }}
                    onClick={() => setActiveTab('reviews')}
                >
                    {isAdmin ? 'All Reviews' : 'My Reviews'}
                </div>
                <div 
                    style={{ padding: '12px 16px', cursor: 'pointer', borderBottom: activeTab === 'goals' ? '2px solid var(--primary)' : 'none', color: activeTab === 'goals' ? 'var(--primary)' : 'var(--text-muted)', fontWeight: activeTab === 'goals' ? 600 : 400 }}
                    onClick={() => setActiveTab('goals')}
                >
                    My Goals
                </div>
                <div 
                    style={{ padding: '12px 16px', cursor: 'pointer', borderBottom: activeTab === 'feedback' ? '2px solid var(--primary)' : 'none', color: activeTab === 'feedback' ? 'var(--primary)' : 'var(--text-muted)', fontWeight: activeTab === 'feedback' ? 600 : 400 }}
            ...
            <div className="perf-content">
                ...
                {activeTab === 'feedback' && <PeerFeedback />}
